...
#include "../../NetworkRequest/benchmark.h"
...
QT_MOC_LITERAL(1, 10, 14), // "waitOnResponse"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(4, 48, 17), // "onRequestFinished"
QT_MOC_LITERAL(5, 66, 12), // "beginWaiting"
QT_MOC_LITERAL(6, 79, 23) // "on_pushButton_2_clicked"

    },
    "Benchmark\0waitOnResponse\0\0"
    "on_pushButton_clicked\0onRequestFinished\0"
    "beginWaiting\0on_pushButton_2_clicked"
};
...
void Benchmark::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Benchmark *_t = static_cast<Benchmark *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->waitOnResponse(); break;
        case 1: _t->on_pushButton_clicked(); break;
        case 2: _t->onRequestFinished(); break;
        case 3: _t->beginWaiting(); break;
        ...
        {
            typedef void (Benchmark::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Benchmark::waitOnResponse)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Benchmark::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Benchmark.data,
      qt_meta_data_Benchmark,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Benchmark::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Benchmark.stringdata0))
        return static_cast<void*>(const_cast< Benchmark*>(this));
