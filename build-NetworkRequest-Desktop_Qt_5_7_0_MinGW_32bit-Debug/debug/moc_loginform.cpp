...
#include "../../NetworkRequest/loginform.h"
...
QT_MOC_LITERAL(1, 10, 13), // "loginComplete"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13), // "responseReady"
QT_MOC_LITERAL(4, 39, 14) // "QNetworkReply*"

    },
    "LoginForm\0loginComplete\0\0responseReady\0"
    "QNetworkReply*"
};
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loginComplete((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        ...
        {
            typedef void (LoginForm::*_t)(QByteArray );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LoginForm::loginComplete)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject LoginForm::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_LoginForm.data,
...
// SIGNAL 0
void LoginForm::loginComplete(QByteArray _t1)
{
