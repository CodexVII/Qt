...
public:
    ...
    {
        LoginWindow->setWindowTitle(QApplication::translate("LoginWindow", "REST API Client", Q_NULLPTR));
        label_12->setText(QApplication::translate("LoginWindow", "Username:", Q_NULLPTR));
        login_username->setText(QString());
        label_13->setText(QApplication::translate("LoginWindow", "Password:", Q_NULLPTR));
