...
public:
    ...
    {
        LoginRegisterWindow->setWindowTitle(QApplication::translate("LoginRegisterWindow", "REST API Client", 0));
        groupBox->setTitle(QApplication::translate("LoginRegisterWindow", "Login", 0));
        label_12->setText(QApplication::translate("LoginRegisterWindow", "Username:", 0));
        login_username->setText(QString());
        label_13->setText(QApplication::translate("LoginRegisterWindow", "Password:", 0));
        login_password->setText(QString());
        login->setText(QApplication::translate("LoginRegisterWindow", "Login", 0));
        groupBox_2->setTitle(QApplication::translate("LoginRegisterWindow", "Register", 0));
        label_6->setText(QApplication::translate("LoginRegisterWindow", "Username:", 0));
        createUser_username->setText(QString());
        label_7->setText(QApplication::translate("LoginRegisterWindow", "Password:", 0));
        createUser_password->setText(QString());
        createUser->setText(QApplication::translate("LoginRegisterWindow", "Register", 0));
    } // retranslateUi
